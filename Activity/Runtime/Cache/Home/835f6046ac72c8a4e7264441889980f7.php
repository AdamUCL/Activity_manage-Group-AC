...
<html>
    <head>
        <meta charset="utf-8">
        <title>My sign up activity</title>
              ...
              <col width="10%">
                ...
                <th>Operation</th>
                  ...
                  <td><?php echo ($row['status']); ?></td>
						      <td class="td-manage">
                        <a title="score" href="javascript:;" onclick="admin_edit('EDIT ACTIVITY','/activity_manage/index.php/Home/Homenotice/score/id/<?php echo ($row['activity_id']); ?>','4','','510')" class="ml-5" style="text-decoration:none" id="edit"><i style="font-size:30px; color: #5FB878;" class="layui-icon">&#xe606;</i></a>&nbsp;&nbsp;&nbsp;&nbsp;
